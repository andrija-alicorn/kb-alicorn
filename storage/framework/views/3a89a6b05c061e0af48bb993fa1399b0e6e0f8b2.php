    ...
    <div class="row">
        ...
        <div class="breadcrumb-container">
            <ol class="breadcrumb">
                ...
                <li class="active"><?php echo e(trans('cruds.article.title')); ?></li>
            </ol>
        </div>
        <!-- END BREADCRUMBS -->
        <!-- ARTICLES -->
        <div class="fb-heading">
            <?php echo e(trans('cruds.article.all')); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/kb.alicorn.org/htdocs/LaravelKnowledgeBaseFAQ/resources/views/articles/index.blade.php ENDPATH**/ ?>