        ...
        <form action="<?php echo e(route("admin.categories.update", [$category->id])); ?>" method="POST" enctype="multipart/form-data">
            ...
            <?php if($category->children->count() == 0): ?>
                ...
                <div class="form-group <?php echo e($errors->has('parent_id') ? 'has-error' : ''); ?>">
                    ...
                    <select id="parent" name="parent_id" class="form-control" value="<?php echo e(old('parent_id', isset($category) ? $category->parent_id : '')); ?>" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/kb.alicorn.org/htdocs/LaravelKnowledgeBaseFAQ/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>