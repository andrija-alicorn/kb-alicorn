    ...
    <div class="row margin-bottom-30">
        <div class="col-md-12 ">
            <div class="support-container">
                <h2 class="support-heading">{{trans('copy.need_more_support') }}</h2>
                <p>
                    {{ __('copy.stackoverflow') }}
                </p>
