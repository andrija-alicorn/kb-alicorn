    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="<?php echo e(route("admin.roles.create")); ?>">
                <?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.role.title_singular_obj')); ?>
...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.list')); ?> <?php echo e(trans('cruds.role.title_plural_obj')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/kb.alicorn.org/htdocs/LaravelKnowledgeBaseFAQ/resources/views/admin/roles/index.blade.php ENDPATH**/ ?>