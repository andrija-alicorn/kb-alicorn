 <div class="container" id="pretraga">
    ...
    <?php echo csrf_field(); ?>
        <div class="form-group">
            <label for="search"><?php echo e(trans('search.search_text')); ?></label>
            <input type="text" id="search" name="search" class="form-control" value="" />
        </div>
        <div class="row">
            <div class="form-group col-md-4">
                <label for="category"><?php echo e(trans('search.category')); ?></label>
            ...
            <div class="form-group col-md-4">
                <label for="subcategory"><?php echo e(trans('search.subcategory')); ?></label>
            ...
            <div class="form-group col-md-4">
                <label for="tag"><?php echo e(trans('search.tag')); ?></label>
        ...
        <div>
            <input class="btn btn-alicorn" type="submit" value="<?php echo e(trans('search.submit')); ?>">
        </div>
    </form>
</div><?php /**PATH /var/www/kb.alicorn.org/htdocs/LaravelKnowledgeBaseFAQ/resources/views/partials/search_form.blade.php ENDPATH**/ ?>