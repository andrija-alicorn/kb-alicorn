...
<head>
    ...
    <link href="<?php echo e(asset('css/custom.css?dss')); ?>" rel="stylesheet" />
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    ...
    <script src="https://cdn.jsdelivr.net/npm/ckeditor5-classic-plus@35.0.1/build/ckeditor.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/moment.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.47/js/bootstrap-datetimepicker.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.5/js/select2.full.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.5.1/min/dropzone.min.js"></script>
    <script src="<?php echo e(asset('js/main.js?sds')); ?>"></script>
    <script>
        $(function() {
...
<?php /**PATH /var/www/kb.alicorn.org/htdocs/LaravelKnowledgeBaseFAQ/resources/views/layouts/admin.blade.php ENDPATH**/ ?>