    ...
    <div class="row">
        ...
        <div class="breadcrumb-container">
            <ol class="breadcrumb">
                ...
                <li class="active">Search again</li>
            </ol>
        </div>
        <!-- END BREADCRUMBS -->
        <!-- ARTICLES -->
        ...
        <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/kb.alicorn.org/htdocs/LaravelKnowledgeBaseFAQ/resources/views/search.blade.php ENDPATH**/ ?>